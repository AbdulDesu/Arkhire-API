...
INSERT INTO `company` VALUES (1,3,'Code With Theresa','Director','Jawa Barat','-6.9175','107.6191','Startup','Code with theresa is the company who...',NULL,NULL,NULL,'company_image-1609608345651.jpg','0000-00-00 00:00:00'),(2,5,'Hololive','Director','Chiba','35.6804','139.7690','Enterprise','Hololive Production adalah proyek agensi Vtuber yang berasal dari Jepang yang dikembangkan oleh COVER Corporation. Hololive awalnya beroperasi di Jepang, kemudian memperluas wilayah operasinya ke China dan Indonesia.',NULL,'https://www.instagram.com/hololive_/','https://web.facebook.com/hololivetv','company_image-1606009556872.jpg','0000-00-00 00:00:00'),(3,7,'Moontoon','CEO','Beijing','39.9042','116.4074','Enterprise','Moonton, sebelumnya YoungJoy Technology Pte. Ltd., kemudian Shanghai Moonton Technology Co. Ltd. adalah pengembang dan penerbit video game China yang berbasis di Shanghai, China .. Didirikan pada bulan April 2014, perusahaan ini terkenal dengan game arena pertempuran online multipemain seluler','https://www.linkedin.com/company/shanghai-moonton-technology-co-ltd/',NULL,NULL,'company_image-1606009572322.jpg','0000-00-00 00:00:00'),(4,9,'Nijisanji ID','Director','Jakarta Pusat','-6.1754','106.8272','Startup','Nijisanji adalah proyek VTuber atau Virtual Liver yang berasal dari Jepang dan dikembangkan oleh Ichikara Inc. Pada April 2020, terdapat lebih dari 100 VTuber anggota Nijisanji yang aktif melakukan berbagai kegiatan di platform streaming video Youtube.',NULL,'https://www.instagram.com/nijisanji_id','https://web.facebook.com/nijisanji.indonesia','company_image-1609683201011.jpg','0000-00-00 00:00:00'),(5,10,'Mihoyo','CEO','Tiongkok','31.2304','121.4737','Enterprise','miHoYo adalah studio animasi dan pengembangan video game Cina yang berbasis di Shanghai, Cina. Perusahaan ini didirikan pada 2012 oleh tiga mahasiswa dari Universitas Shanghai Jiao Tong dan, pada 2020, mempekerjakan lebih dari 1.500 orang','https://www.linkedin.com/company/mihoyo-co-ltd-/','https://www.instagram.com/mihoyo_jp','https://web.facebook.com/miHoYogames','company_image-1609683242682.jpg','0000-00-00 00:00:00'),(6,20,'Lily Gardens','CEO','Jawa Timur','-37.1052','-12.2777','Software House','Garden is a training facility that CHARM users have established in order to help combat humanity in the Assault Lily Bouquet anime, Assault Lily novel and Assault Lily toyline. It also functions as a military training high school with high school education. ',NULL,NULL,NULL,'company_image-1609684159848.png','2021-01-06 11:02:43'),(8,23,'Torus Bilogic Lab','R&D','Jakarta Selatan','-7.005636666666667','107.8615','Enterprise','We develop and deploy machine learning and artificial intelligence solutions, leveraging shape analytics approaches to enhance state-of-the-art methodologies.','thinktorus','','','company_image-1610290932462.jpg','2021-01-06 11:02:43');
...
CREATE TABLE `companycontributor` (
  ...
  `participator_owner` int DEFAULT NULL,
  PRIMARY KEY (`contributorID`),
  KEY `participator_name` (`participator_owner`),
  CONSTRAINT `companycontributor_ibfk_1` FOREIGN KEY (`participator_owner`) REFERENCES `hiring` (`offeringID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `companycontributor` VALUES (1,1),(2,2),(7,5),(8,11),(9,12),(11,16);
...
CREATE TABLE `companyproject` (
  ...
  CONSTRAINT `companyproject_ibfk_3` FOREIGN KEY (`project_owner`) REFERENCES `company` (`companyID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `companyproject` VALUES (1,'Create Hyperion Absent Apps','1 WEEK','Make A Automatic absent for hyperion employee','Rp. 3.000.000','project_image-1610553195376.png',1,'0000-00-00 00:00:00'),(2,'Create Hololive Website','1 WEEK','In this project, we invite you to contribute on our...','Rp. 8.000.000','project_image-1610553148130.png',2,'0000-00-00 00:00:00'),(5,'Update our Deep Fake Tech','3 MONTH','In this project, we invite you to contribute on our...','Rp. 14.000.000','project_image-1610552985806.png',4,'0000-00-00 00:00:00'),(11,'Lily Gardens Api','2 Month','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.','Rp.  8.000.000','project_image-1610552780657.png',6,'2021-01-06 10:21:13'),(12,'E-Wallet Torus Apps','6 MONTH','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.','Rp. 16.000.000','project_image-1610552674586.jpg',8,'2021-01-06 10:23:05'),(17,'Genshin Impact Moefication','6 MONTH','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.','Rp. 9.000.000','project_image-1610552504946.jpg',8,'2021-01-12 14:55:30'),(19,'Hololie Visual Novel','8 MONTH','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.','Rp. 23.000.000','project_image-1610552037496.png',2,'2021-01-13 15:33:57');
...
CREATE TABLE `hiring` (
  ...
  KEY `offering_owner` (`offering_owner`),
  CONSTRAINT `hiring_ibfk_1` FOREIGN KEY (`projectID`) REFERENCES `companyproject` (`projectID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `hiring_ibfk_2` FOREIGN KEY (`offering_owner`) REFERENCES `talent` (`talentID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `hiring` VALUES (1,2,15,'Approved','Thank you for adding me to your project sir, I appreciate it','0000-00-00 00:00:00'),(2,2,15,'Waiting','Sorry, I am in other busy project','0000-00-00 00:00:00'),(5,5,15,'Declined','Sorry Sir, I can accept your offering project. Because that\'s quest is very difficult for me','0000-00-00 00:00:00'),(11,11,15,'Waiting',NULL,'2021-01-06 10:29:27'),(12,17,10,'Waiting',NULL,'2021-01-06 10:29:27'),(16,17,14,'Waiting',NULL,'2021-01-13 02:55:43');
...
INSERT INTO `talentexperience` VALUES (2,22,'Minercraft Contributor','Mojang.inc','2019','2020','Contributor mojang, fixing bug and do the application testing','2021-01-06 13:23:29'),(3,22,'Hololive 2nd Generation Talent','Hololive English','2019','2019','Become Hololive 2nd talent','2021-01-06 13:52:00'),(4,19,'Software Engineer','Hololive English','2018','2020','Become Software engineer, who handle all talent of hololive en member','2021-01-06 14:29:06'),(5,19,'Hololive Talent','','','','Done',NULL),(6,19,'Content Creator','Pekora Ch','2020','2021','Done',NULL),(7,19,'Minecraft Player','Mojang.Inc','2020','2020','',NULL);
...
INSERT INTO `talentskill` VALUES (1,1,'Kotlin','Java','HTML','CSS','JavaScript','0000-00-00 00:00:00'),(2,2,'HTML','CSS','JavaScript','React','React Natve','0000-00-00 00:00:00'),(3,3,'Kotlin','React','Java','Laravel','Python','0000-00-00 00:00:00'),(4,4,'Javascript','React Native','HTML ','CSS','Python','0000-00-00 00:00:00'),(5,5,'Laravel','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(6,6,'Laravel','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(7,7,'Angular','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(8,8,'HTML & CSS','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(9,9,'React','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(10,10,'Vue','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(11,11,'MongoDB','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(12,12,'Laravel','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(13,13,'Laravel','React Native','Javascript','Kotlin','Python','0000-00-00 00:00:00'),(14,14,'Kotlin','React','Java','Laravel','Python','0000-00-00 00:00:00'),(15,15,'Golang','Java','React','Kotlin','Python',NULL),(16,16,NULL,NULL,NULL,NULL,NULL,'2021-01-14 15:05:38');
...
-- Dump completed on 2021-01-14 15:47:45
