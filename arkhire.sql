...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2021 at 07:10 PM
...
(8, 23, 'Ei. inc', 'R&D', '-7.005636666666667', '107.8615', 'Enterprise', 'We develop and deploy machine learning and artificial intelligence solutions, leveraging shape analytics approaches to enhance state-of-the-art methodologies.', 'thinktorus', '', '', 'company_image-1610290932462.jpg', '2021-01-06 11:02:43');
...
(1, 'Create Hyperion Absent Apps', '1 WEEK', 'Make A Automatic absent for hyperion employee', 'Rp. 3.000.000', 3, 2, '0000-00-00 00:00:00'),
(2, 'Create Hololive Website', '1 WEEK', 'In this project, we invite you to contribute on our...', 'Rp. 8.000.000', 20, 19, '0000-00-00 00:00:00'),
(4, 'Create A Hololive Visual Novel Game', '1 MONTH', 'In this project, we invite you to contribute on our...', 'Rp. 12.000.000', 20, 22, '0000-00-00 00:00:00'),
(5, 'Update our Deep Fake Tech', '3 MONTH', 'In this project, we invite you to contribute on our...', 'Rp. 14.000.000', 23, 19, '0000-00-00 00:00:00'),
(7, 'Make me a music player apps', '6 MONTH', 'In this project, we invite you to contribute on our...', 'Rp. 9.000.000', 23, 22, '0000-00-00 00:00:00'),
(10, 'Torus A.I Recognition', '4 WEEK', 'orem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a', 'Rp. 32.000.000', 23, 19, '2021-01-06 10:16:03'),
(11, 'Lily Gardens Api', '2 Month', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'Rp.  8.000.000', 20, 15, '2021-01-06 10:21:13'),
(12, 'E-Wallet Torus Apps', '6 MONTH', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'Rp.  6.000.000', 23, 19, '2021-01-06 10:23:05'),
(15, 'E-Wallet Torus Apps', '6 MONTH', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'Rp.  16.000.000', 7, 22, '2021-01-08 12:31:38');
...
(15, 15, 'Declined', 'Y', '2021-01-08 12:31:38');
...
--
ALTER TABLE `companyproject`
  ADD CONSTRAINT `companyproject_ibfk_1` FOREIGN KEY (`project_owner`) REFERENCES `account` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE,
