...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2021 at 05:10 PM
...
(1, 'Create Hyperion Absent Apps', '1 WEEK', 'Make A Automatic absent for hyperion employee', '3000000', 'project_image-1610553195376.png', 1, '0000-00-00 00:00:00'),
(2, 'Create Hololive Website', '1 WEEK', 'In this project, we invite you to contribute on our...', '8000000', 'project_image-1610553148130.png', 2, '0000-00-00 00:00:00'),
(5, 'Update our Deep Fake Tech', '3 MONTH', 'In this project, we invite you to contribute on our...', '14000000', 'project_image-1610552985806.png', 4, '0000-00-00 00:00:00'),
(11, 'Lily Gardens Api', '2 Month', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '8000000', 'project_image-1610552780657.png', 6, '2021-01-06 10:21:13'),
(12, 'E-Wallet Torus Apps', '6 MONTH', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '16000000', 'project_image-1610552674586.jpg', 8, '2021-01-06 10:23:05'),
(17, 'Genshin Impact Moefication', '6 MONTH', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '9000000', 'project_image-1610552504946.jpg', 8, '2021-01-12 14:55:30'),
(19, 'Hololie Visual Novel', '8 MONTH', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '23000000', 'project_image-1610552037496.png', 2, '2021-01-13 15:33:57');
...
CREATE TABLE `hiring` (
  ...
  `offered_salary` text DEFAULT NULL,
...
INSERT INTO `hiring` (`offeringID`, `projectID`, `offering_owner`, `hiring_status`, `offered_salary`, `reply_message`, `repliedAt`) VALUES
(1, 2, 15, 'Approved', '2000000', 'Thank you for adding me to your project sir, I appreciate it', '0000-00-00 00:00:00'),
(2, 2, 15, 'Waiting', '5000000', 'Sorry, I am in other busy project', '0000-00-00 00:00:00'),
(5, 5, 15, 'Declined', '8000000', 'Sorry Sir, I can accept your offering project. Because that\'s quest is very difficult for me', '0000-00-00 00:00:00'),
(11, 11, 15, 'Waiting', '4000000', NULL, '2021-01-06 10:29:27'),
(12, 17, 10, 'Waiting', '6000000', NULL, '2021-01-06 10:29:27'),
(16, 17, 14, 'Waiting', '2000000', NULL, '2021-01-13 02:55:43');
...
(16, 24, NULL, NULL, NULL, NULL, NULL, NULL, '2021-01-14 15:05:38');
...
(16, 16, NULL, NULL, NULL, NULL, NULL, '2021-01-14 15:05:38');
...
--
ALTER TABLE `achivement`
  MODIFY `achivementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `companycontributor`
  MODIFY `contributorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `hiring`
  MODIFY `offeringID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `talent`
--
ALTER TABLE `talent`
  MODIFY `talentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
