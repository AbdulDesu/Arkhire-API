...
module.exports = {
  ...
  createCompany: async (req, res) => {
    try {
      const { company_name, company_position, company_type, company_detail, company_location, company_latitude, company_longitude, company_linkedin, company_instagram, company_facebook, updatedAt } = req.body
      const result = await createCompanyModel(company_name, company_position, company_type, company_detail, company_location, company_latitude, company_longitude,  company_linkedin, company_instagram, company_facebook, updatedAt)
